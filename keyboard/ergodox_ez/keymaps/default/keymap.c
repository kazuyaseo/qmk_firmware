 ...
 *                                 `--------------------'       `----------------------'
 */
/* Keymap 0: Basic layer(Customize)
 *
 * ,--------------------------------------------------.           ,--------------------------------------------------.
...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_LSFT,        KC_Z,         KC_X,   KC_C,   KC_V,   KC_B,   KC_RO,
        KC_FN1 ,        KC_QUOT,      KC_LALT,  KC_LGUI , KC_MHEN,
        ...
        // right hand
             ...
             KC_GRV ,     KC_N,   KC_M,   KC_COMM,KC_DOT, CTL_T(KC_SLSH),   KC_RO,
                          KC_ZKHK,KC_EQL, KC_RBRC,KC_BSLS,               KC_PIPE,
             KC_LALT,        KC_RCTRL,
             KC_PGUP,
...
[SYMB] = KEYMAP(
       ...
       KC_TRNS, KC_TRNS,   KC_TRNS, KC_TRNS, KC_TRNS, KC_ASTR, KC_F12,
